...
<article class="item" data-permalink="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($this->item->slug, $this->item->catid), true, -1); ?>">
	...
	<header>
    	...
    	<?php if (isset($imgfloat) && htmlspecialchars($imgfloat) != 'none') : ?>
			<a data-spotlight="on" href="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($this->item->slug, $this->item->catid)); ?>" title="<?php echo $this->escape($this->item->title); ?>"><?php echo $image; ?></a>
		<?php endif; ?>
