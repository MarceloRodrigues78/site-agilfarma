...
<article class="item" data-permalink="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($this->item->slug, $this->item->catid), true, -1); ?>">
    ...
    <?php if (isset($imgfloat) && htmlspecialchars($imgfloat) != 'none') : ?>
			<a  data-spotlight="off"   href="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($this->item->slug, $this->item->catid)); ?>"  title="<?php echo $this->escape($this->item->title); ?>"><?php echo $image;  ?></a>
		<?php endif; ?>
	...
	<p class="links">
		...
		<a class="button-primary" href="<?php echo $link; ?>" title="<?php echo $this->escape($this->item->title); ?>">
			<?php
